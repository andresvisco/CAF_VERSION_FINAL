...
def get_auth_url():
    return msal_app.get_authorization_request_url(SCOPE, redirect_uri=f"http://localhost:8501{REDIRECT_PATH}")

def get_token_from_code(auth_code):
    return msal_app.acquire_token_by_authorization_code(auth_code, scopes=SCOPE, redirect_uri=f"http://localhost:8501{REDIRECT_PATH}")
